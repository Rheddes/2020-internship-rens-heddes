...
def main(argv):
    ...
    call_graph_properties(os.path.join(BASE_DIR, 'data', 'call_graph_stats.csv'), './output/chapter5/runtime')
    centrality_correlations(os.path.join(BASE_DIR, 'data', 'correlation.csv'), './output/chapter5')

    plot_exhaustive_runtime_analysis(os.path.join(BASE_DIR, 'data', 'runtimes_for_projects.csv'), './output/chapter5/runtime')
    plot_exhaustive_runtime_factors(os.path.join(BASE_DIR, 'data', 'extensive_runtime.csv'), './output/chapter5/runtime')

    plot_rbo(os.path.join(BASE_DIR, 'data', 'results_100.csv'), './output/chapter5/risk')  # input variable --rbo ??
    plot_rbo_for_graphsizes(os.path.join(BASE_DIR, 'data', 'results_webtau.csv'), './output/chapter5/risk')
